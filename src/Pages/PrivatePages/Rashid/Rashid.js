...
const Rashid = () => {
  ...
  return (
    ...
    <RashidContainer>
      ...
      <Row gutter={[16, 16]}>
        {
          newNav.rashidNav.map(e => {
            console.log(e.pathname, "hello")
            return(
            <Col sm={24} md={8} xs={24} lg={6} key={e.pathname}>
          
              <Link className='customNavLink' to={`/admin/rashid/${e.pathname}`} pathname={e.pathname}>
...
const RashidContainer = styled.div`
   .cButton{
    height: 120px;
    width: 100%;
    border-radius: 10px;
