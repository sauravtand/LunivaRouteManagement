...
import {  getTotalBillCharge } from "../../../Services/ReportService";
...
const TotalBillCharge = () => {
  ...
  const returnFilterData = (res) => {
      ...
      getTotalBillCharge(data, (newRes) => {
          makeTableData(newRes)
      })
  }
  // Title
  const Title = 'Total Bill Charge'
  return (
...
export default TotalBillCharge